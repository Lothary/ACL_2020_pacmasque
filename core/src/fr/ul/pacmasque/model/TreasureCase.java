...
public class TreasureCase implements Case {
    private final Vector2 position;

    public TreasureCase(int x, int y){
    ...
    public Texture getTexture() throws TextureException {
        return Objects.requireNonNull(TexturePackFactory.getInstance().getTexturePack("basepack")).get(TexturePack.typeTexture.treasure);
    }
}
