...
public class WinView extends OverlayView {
     ...
     */
    public WinView(float viewportWidth, float viewportHeight, @NotNull Skin skin, World world) {
    ...
    public void show() {
        ...
        if (Pacmasque.ENVIRONMENT == Pacmasque.Environment.PRODUCTION) {
            FileHandle internal = Gdx.files.internal("sounds/win.ogg");
            if (internal.exists()) {
